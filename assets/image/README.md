...
The local MVP build tags the wrapper image as `localhost/agentbox-opencode:local`.
The container defaults to the non-root `user` account with `HOME=/home/user`.
