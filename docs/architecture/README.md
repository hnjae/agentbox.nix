...
- `clean` must discover image cleanup candidates from agentbox image ownership labels, volume cleanup candidates from current workspace cache volume naming rules, and lock file cleanup candidates from the current workspace lock path rules.
